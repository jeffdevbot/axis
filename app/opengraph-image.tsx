...
export const alt = "Axis Brands Group — Your Amazon Partner. Not Your Amazon Agency.";
export const size = { width: 1200, height: 1200 };
export const contentType = "image/png";

const STATS = [
  { n: "20+", label: "Brands Managed" },
    ...
    (
      <div
        style={{
          ...
          backgroundImage:
            "radial-gradient(circle at 85% 15%, rgba(29,78,216,0.35), rgba(29,78,216,0) 55%)",
          color: "#ffffff",
        }}
      >
        <AxisMark />
